...
for (k,f) in enumerate([
        ...
        "case118_ieee",
        "case162_ieee_dtc",
        "case200_pserc", # uniform = 6000-7000 samples, gaussian = 4600 - 4700 samples
        "case240_pserc", # will not terminate for uniform or gaussian
...
JLD.save("summary_gaussian.jld", "M", M, "K_M", K_M, "R_MW", R_MW, "W", W, "R_OS", R_OS, "W_test", W_test)
